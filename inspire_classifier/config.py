...
CLASSIFIER_PRETRAINED_LANGUAGE_MODEL_ENCODER_PATH = os.path.join(
    CLASSIFIER_LANGUAGE_MODEL_DIR, 'wikitext_103', 'fwd_wt103_enc.h5')
CLASSIFIER_FINETUNED_LANGUAGE_MODEL_PATH = os.path.join(
    CLASSIFIER_LANGUAGE_MODEL_DIR, 'finetuned_language_model.h5')
